export const customViewports = {
    ...
    landscape0: {name: "Landscape 500x500", styles: {width: "500px", height: "500px"}},
    landscape1: {name: "Landscape 600x500", styles: {width: "600px", height: "500px"}},
    landscape2: {name: "Landscape 700x500", styles: {width: "700px", height: "500px"}},
    landscape3: {name: "Landscape 800x500", styles: {width: "800px", height: "500px"}},
    landscape4: {name: "Landscape 900x500", styles: {width: "900px", height: "500px"}},
    landscape5: {name: "Landscape 1000x500", styles: {width: "1000px", height: "500px"}},
    landscape6: {name: "Landscape 700x700", styles: {width: "700px", height: "700px"}},
    landscape7: {name: "Landscape 800x700", styles: {width: "800px", height: "700px"}},
    landscape8: {name: "Landscape 900x700", styles: {width: "900px", height: "700px"}},
    landscape9: {name: "Landscape 1000x700", styles: {width: "1000px", height: "700px"}},
    landscape10: {name: "Landscape 1100x700", styles: {width: "1100px", height: "700px"}},
    landscape11: {name: "Landscape 1200x700", styles: {width: "1200px", height: "700px"}},
    landscape12: {name: "Landscape 1300x700", styles: {width: "1300px", height: "700px"}},
    landscape13: {name: "Landscape 1400x700", styles: {width: "1400px", height: "700px"}},
    landscape14: {name: "Landscape 1500x700", styles: {width: "1500px", height: "700px"}},
    landscape15: {name: "Landscape 1600x700", styles: {width: "1600px", height: "700px"}},
    landscape16: {name: "Landscape 1700x700", styles: {width: "1700px", height: "700px"}},
    landscape17: {name: "Landscape 1800x700", styles: {width: "1800px", height: "700px"}},
    landscape18: {name: "Landscape 1900x700", styles: {width: "1900px", height: "700px"}},
    landscape19: {name: "Landscape 2000x700", styles: {width: "2000px", height: "700px"}},
    landscape20: {name: "Landscape 2100x700", styles: {width: "2100px", height: "700px"}},
    landscape21: {name: "Landscape 2100x800", styles: {width: "2100px", height: "800px"}},
    landscape22: {name: "Landscape 2100x900", styles: {width: "2100px", height: "900px"}},
    landscape23: {name: "Landscape 2100x1000", styles: {width: "2100px", height: "1000px"}},
    landscape24: {name: "Landscape 2100x1100", styles: {width: "2100px", height: "1100px"}},
    landscape25: {name: "Landscape 2200x1100", styles: {width: "2200px", height: "1100px"}},
    landscape26: {name: "Landscape 2300x1100", styles: {width: "2300px", height: "1100px"}},
    landscape27: {name: "Landscape 2400x1100", styles: {width: "2400px", height: "1100px"}},
    landscape28: {name: "Landscape 2500x1100", styles: {width: "2500px", height: "1100px"}},
